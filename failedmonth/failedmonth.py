...
ax =categories.plot(kind='bar', color=colors,title= 'Quantity of unsuccessful project in particular months ',fontsize=20)
ax.set_xlabel("Months",fontsize=25)
ax.set_ylabel("Number of projects",fontsize=25)
ax.title.set_size(40)

plt.savefig('failedmonth.png')

plt.clf()


figure(figsize=(10,8),dpi=200)
ax2 = categories.plot(kind='box',title= 'Quantity of unsuccessful project in particular months' )
ax2.title.set_size(30)
ax2.set_ylabel("Number of projects",fontsize=20)
plt.savefig('failedmonth-box.png')
