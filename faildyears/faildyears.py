...
ax =categories.plot(kind='bar', color=colors,title= 'Quantity of unsuccessful project through years',fontsize=20)
...
ax2 = categories.plot(kind='box',title= 'Quantity of unsuccessful project through years' )
ax2.title.set_size(30)
ax2.set_ylabel("Number of projects",fontsize=20)
plt.savefig('failed-box.png')
